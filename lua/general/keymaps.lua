...
map("n", "th", ":BufferLineMovePrev<CR>", { silent = true })
map("n", "t<Left>", ":BufferLineMovePrev<CR>", { silent = true })
map("n", "tl", ":BufferLineMoveNext<CR>", { silent = true })
map("n", "t<Right>", ":BufferLineMoveNext<CR>", { silent = true })
